...
const maxTries = 10; // max # of tries
var letter = "";
...
var game = {
    ...
    winSound: new Audio(), // holds win sound
    loseSound: new Audio(), // holds lose sound

    // reset game function that resets all variables
    resetGame: function (){
